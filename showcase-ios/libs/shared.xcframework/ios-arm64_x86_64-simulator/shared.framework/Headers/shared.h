 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getVideoStreamDataFixtureData:(SharedFixtureResponse *)fixtureData authHeaders:(SharedVideoApiAuthHeaders *)authHeaders completionHandler:(void (^)(SharedFixtureStreamResponse * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getVideoStreamData(fixtureData:authHeaders:completionHandler:)")));
@end
...
@property NSString *Auth_Domain __attribute__((swift_name("Auth_Domain")));
...
@property NSString *Video_API_Domain __attribute__((swift_name("Video_API_Domain")));
@property NSString *Video_API_FixturePath __attribute__((swift_name("Video_API_FixturePath")));
@property NSString *Video_API_LivePlayer __attribute__((swift_name("Video_API_LivePlayer")));
...
@property NSString *baseGeniusLivePlayerUrl __attribute__((swift_name("baseGeniusLivePlayerUrl")));
 ...
 * Other uncaught Kotlin exceptions are fatal.
*/
- (void)getVideoStreamVideoConfiguration:(SharedVideoConfiguration *)videoConfiguration completionHandler:(void (^)(NSString * _Nullable, NSError * _Nullable))completionHandler __attribute__((swift_name("getVideoStream(videoConfiguration:completionHandler:)")));
@end
